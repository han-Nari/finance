<?php 
	...
	include "capital_fetch.php";
	include "capital_delete.php";
					...
					<table>
						<caption>
							<div class="flex">
								...
								<div class="add_admin">
									<a href="print_capital.php" ><i class="fa-solid fa-print"></i></a>
									<a href="capital_add.php">Add Account</a>
								</div>
							</div>
						</caption>
						<thead>
						...
						<tbody>
							<?php foreach($results as $result) : ?>
								<tr>
									...
									<td data-cell="Expenses"><?php echo $result["expenditures"]; ?></td>
									<td data-cell="Approriation"><?php echo $result["appropriation"]; ?></td>
									<td data-cell="Date"><?php echo $result["created_at"]; ?></td>
									<td data-cell="Edit"><a class="edit" href="capital_edit.php?id=<?php echo htmlspecialchars($result["id"]); ?>">Edit</a></td>
									<td data-cell="Delete">
