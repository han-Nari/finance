<?php 
	...
	include "maintenance_update.php";
		...
		<div class="container">
			...
			<form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">	
				<div class="box pwd">
					...
					<input type="text" name="expenses" placeholder="Expenses" value="<?php echo $results["expenses"]; ?>">
				</div>
				...
				<div class="back">
					<p>Back to <a id="back" href="maintenance.php">
Maintenance & Other Operating Expenses</a></p>
				</div>
			</form>
		</div>	
	</section>
