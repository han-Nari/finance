...
<body>
	...
	<!-- Main content -->
		<section>
				<h1 class="title">Cash Books</h1>
				<div class="grid">
					<div class="fund">
						<a class="bg-color" href="fund.php">LGU's Allocated Fund</a>
					</div>
					<div class="fees">
						<a class="bg-color" href="../">Barangay Fees and Taxes</a>
					</div>
					<div class="charges">
						<a class="bg-color" href="../">Other Fees and Charges</a>
					</div>
				</div>
		</section>
	</main>
